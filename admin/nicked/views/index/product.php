...
?>
<link rel="stylesheet" href="/statics/css/web/story.css">
    ...
    <div class="head_top">
        <div class="head">
            <ul id="menu" class="menu menu1">
                ...
                <li><a id="explorePage" class="menua" href="/index/explore"><span class="c-menu__inner">全球专利</span></a></li>
                <li class="hj_story">
                    <a id="productPage" class="menua" href="/index/product"><span class="c-menu__inner">美国原装</span></a>
                    <div class="under_menu">
                        <a class="under_img" href="#"><img src="http://image.nakedchina.com.cn/uploads/images/web/yuanzhuang-black.jpg"></a>
                ...
                <li id="hj_story" class="hj_story">
                    ...
                    <div class="under_menu">
                        <a class="under_img" href="#"><img src="http://image.nakedchina.com.cn/uploads/images/web/zhenxuan.jpg"></a>
                        <ul class="under_ul">
                            <li>臻选套装</li>
...
<img width="100%" src="http://image.nakedchina.com.cn/uploads/images/web/shuanghe-detail.jpg">
<div class="foot f14">
    <div class="foot_top">
        <ul>
            <li>
