...
<div class="panel mb-3">
    <div class="panel-header">
        ...
        <ul class="nav nav-right">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createUrl(['admin/store/express-edit']) ?>">添加设置项</a>
            </li>
            <li class="nav-item">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['admin/store/express-edit', 'id' => $value['id']]) ?>">修改</a>

                        <a class="del btn btn-sm btn-danger" href="javascript:"
                           data-content="是否删除？"
                           data-url="<?= $urlManager->createUrl(['admin/store/express-del', 'id' => $value['id']]) ?>">删除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class=" auto-submit-form" method="post" autocomplete="off"
                      data-return="<?= $urlManager->createUrl(['admin/store/express']) ?>">
