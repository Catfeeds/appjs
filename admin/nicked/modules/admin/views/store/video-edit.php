...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <form class="auto-form" method="post" return="<?= $urlManager->createUrl(['admin/store/video']) ?>">
        ...
        video_picker.each(function (i) {
            ...
            function uploaderVideo() {
                ...
                var uploader = new plupload.Uploader({
                    ...
                    url: url,
                    flash_swf_url: '<?=$statics?>/admin/js/Moxie.swf',
                    silverlight_xap_url: '<?=$statics?>/admin/js/Moxie.xap',
