...
<div class="panel mb-3">
    <div class="panel-header">
        ...
        <ul class="nav nav-right">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createAbsoluteUrl(['admin/store/video-edit']) ?>">添加视频</a>
            </li>
        </ul>
    </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-footer text-muted">
                                <a class="btn btn-sm btn-primary"
                                   href="<?= $urlManager->createAbsoluteUrl(['admin/store/video-edit', 'id' => $value['id']]) ?>">修改</a>
                                <a class="btn btn-sm btn-danger del"
                                   href="<?= $urlManager->createAbsoluteUrl(['admin/store/video-del', 'id' => $value['id']]) ?>">删除</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
