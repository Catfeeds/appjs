...
<div class="panel mb-3">
    <div class="panel-header">
        ...
        <ul class="nav nav-right">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createAbsoluteUrl(['admin/store/cat-edit']) ?>">添加分类</a>
            </li>
        </ul>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['admin/store/cat-edit', 'id' => $cat['id']]) ?>">修改</a>
                        ...
                        <a class="btn btn-sm btn-danger del"
                           href="<?= $urlManager->createUrl(['admin/store/cat-del', 'id' => $cat['id']]) ?>">删除</a>
                    </td>
                </tr>
                <?php foreach ($cat->childrenList as $sub_cat): ?>
                    <tr class="bg-faded">
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-primary"
                               href="<?= $urlManager->createUrl(['admin/store/cat-edit', 'id' => $sub_cat['id']]) ?>">修改</a>
                            <a class="btn btn-sm btn-primary copy"
                               data-clipboard-text="/pages/list/list?cat_id=<?= $sub_cat['id'] ?>"
                               href="javascript:" hidden>复制链接</a>
                            <a class="btn btn-sm btn-danger del"
                               href="<?= $urlManager->createUrl(['admin/store/cat-del', 'id' => $sub_cat['id']]) ?>">删除</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endforeach; ?>
