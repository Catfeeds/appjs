...
<div class="panel mb-3">
    <div class="panel-header">
        ...
        <ul class="nav nav-right">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createAbsoluteUrl(['admin/store/slide-edit']) ?>">添加轮播图</a>
            </li>
        </ul>
    </div>
            ...
            <div class="card mb-3" style="display: inline-block;width: 300px">
                ...
                <div class="card-footer text-muted">
                    <a class="btn btn-sm btn-primary"
                       href="<?= $urlManager->createUrl(['admin/store/slide-edit', 'id' => $value['id']]) ?>">修改</a>
                    <a class="btn btn-sm btn-danger del"
                       href="<?= $urlManager->createUrl(['admin/store/slide-del', 'id' => $value['id']]) ?>">删除</a>
                </div>
            </div>
        <?php endforeach; ?>
