...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <a class="btn btn-primary mb-3" href="<?= $urlManager->createUrl(['admin/coupon/edit']) ?>">添加优惠券</a>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['admin/coupon/edit', 'id' => $item->id]) ?>">编辑</a>
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['admin/coupon/send', 'id' => $item->id]) ?>">发放</a>
                        <a class="btn btn-sm btn-danger delete-confirm"
                           href="<?= $urlManager->createUrl(['admin/coupon/delete', 'id' => $item->id]) ?>">删除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
