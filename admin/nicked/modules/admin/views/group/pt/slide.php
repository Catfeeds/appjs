...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <a href="<?= $urlManager->createAbsoluteUrl(['admin/group/pt/slide-edit']) ?>" class="btn btn-primary mb-3">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-footer text-muted">
                                <a class="btn btn-sm btn-primary"
                                   href="<?= $urlManager->createUrl(['admin/group/pt/slide-edit', 'id' => $value['id']]) ?>">修改</a>
                                <a class="btn btn-sm btn-danger del"
                                   href="<?= $urlManager->createUrl(['admin/group/pt/slide-del', 'id' => $value['id']]) ?>">删除</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
