                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                        ...
                        <a class="dropdown-item"
                           href="<?= $urlManager->createUrl(array_merge(['admin/group/data/user'], $Gets, ['status' => 1])) ?>">按消费金额</a>
                        <a class="dropdown-item"
                           href="<?= $urlManager->createUrl(array_merge(['admin/group/data/user'], $Gets, ['status' => 2])) ?>">按订单数</a>
                    </div>
                </div>
            </div>
