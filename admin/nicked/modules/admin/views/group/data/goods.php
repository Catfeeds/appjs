...
$this->params['page_navs'] = [
    [
        'name' => '销售统计',
        'active' => true,
        'url' => $urlManager->createUrl(['admin/group/data/goods', 'cat_id' => 1,]),
    ],
    [
        'name' => '用户统计',
        'active' => false,
        'url' => $urlManager->createUrl(['admin/group/data/user', 'cat_id' => 2,]),
    ],
];
?>
<style>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                        ...
                        <a class="dropdown-item"
                           href="<?= $urlManager->createUrl(array_merge(['admin/group/data/goods'], $Gets, ['status' => 1])) ?>">按销量</a>
                        <a class="dropdown-item"
                           href="<?= $urlManager->createUrl(array_merge(['admin/group/data/goods'], $Gets, ['status' => 2])) ?>">按销售额</a>
                    </div>
                </div>
            </div>
