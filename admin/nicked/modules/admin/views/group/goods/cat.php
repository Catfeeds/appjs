    ...
    <div class="panel-body">
        ...
        <div class="mb-3 clearfix">
            <div class="float-left">
                <a href="<?= $urlManager->createUrl(['admin/group/goods/cat-edit']) ?>" class="btn btn-primary"><i
                ...
                <tr>
                    ...
                    <td class="nowrap">
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['admin/group/goods/cat-edit', 'id' => $cat->id]) ?>">修改</a>
                        <a class="btn btn-sm btn-danger del"
                           href="<?= $urlManager->createUrl(['admin/group/goods/cat-del', 'id' => $cat->id]) ?>">删除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
