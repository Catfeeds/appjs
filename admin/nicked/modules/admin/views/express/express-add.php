...
<div class="p-3">
    <a href="<?= $urlManager->createUrl(['admin/express/express']) ?>">收费地区</a>

    <hr>
    <div class="p-3">
        <a href="<?= $urlManager->createAbsoluteUrl(['admin/express/express']) ?>" class="btn btn-primary">返回</a>
    </div>
...
<script>
    $(function(){
        $("#province").change(function (){
            ...
            var url = "<?=$urlManager->createAbsoluteUrl(['admin/express/express-city'])?>";
            $.ajax({
                type:'get',
                url: url,
                dataType:'json',
