...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <a class="btn btn-primary mb-3" href="<?= $urlManager->createUrl(['admin/card/edit']) ?>">添加卡券</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary"
                               href="<?= $urlManager->createUrl(['admin/card/edit', 'id' => $value['id']]) ?>">编辑</a>
                            <a class="btn btn-sm btn-danger del" href="javascript:"
                               data-content="是否删除？"
                               data-url="<?= $urlManager->createUrl(['admin/card/del', 'id' => $value['id']]) ?>">删除</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
