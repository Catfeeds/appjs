        ...
        <table class="table table-bordered bg-white">
            ...
            <?php foreach ($list as $u): ?>
                <tr>
                    ...
                    <td>核销员</td>
                    <td>
                        <a href="<?= $urlManager->createUrl(['admin/order/index', 'clerk_id' => $u['id']]) ?>"><?= $u['order_count'] ?></a>
                    </td>
                    <td>
                        <a href="<?= $urlManager->createUrl(['admin/user/card', 'clerk_id' => $u['id']]) ?>"><?= $u['card_count'] ?></a>
                    </td>
                    <td>
                        <?php if ($u['is_clerk'] == 0): ?>
                            <a class="btn btn-sm btn-primary del" href="javascript:"
                               data-url="<?= $urlManager->createUrl(['admin/user/clerk-edit', 'id' => $u['id'], 'status' => 1]) ?>"
                               data-content="是否设为核销员？">设为核销员</a>
                        <?php else: ?>
                            <a class="btn btn-sm btn-danger del" href="javascript:"
                               data-url="<?= $urlManager->createUrl(['admin/user/clerk-edit', 'id' => $u['id'], 'status' => 0]) ?>"
                                ...
                                <div class="col-9">
                                    ...
                                    <template v-else>
                                        <label class="col-form-label">暂未设置门店，<a
                                                href="<?= $urlManager->createUrl(['admin/store/shop']) ?>">请前往设置</a></label>
                                    </template>
                                </div>
                            </div>
                            <template v-if="shop_list.length>0">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-primary send" href="javascript:"
                               data-url="<?= $urlManager->createUrl(['admin/user/clerk-edit', 'status' => 1, 'edit' => 1]) ?>"
