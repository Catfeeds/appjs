...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <a class="btn btn-primary" href="<?= $urlManager->createUrl(['admin/user/level-edit']) ?>">会员设置</a>
                ...
                <tr>
                    ...
                    <td class="nowrap">
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['admin/user/level-edit', 'id' => $value['id']]) ?>">编辑</a>
                        <a class="btn btn-sm btn-danger del" href="javascript:" data-content="是否删除？"
                           data-url="<?= $urlManager->createUrl(['admin/user/level-del', 'id' => $value['id']]) ?>">删除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
...
<script>
    $(document).on('click', '.status', function () {
        ...
        $.myConfirm({
            ...
            confirm: function () {
                $.ajax({
                    url: "<?=$urlManager->createUrl(['admin/user/level-type'])?>",
                    dataType: 'json',
                    type: 'get',
                    data: {
                        type: type,
