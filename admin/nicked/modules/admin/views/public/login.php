...
<head>
    ...
    <title>naked中国后台管理系统登录</title>
    <link href="<?= Yii::$app->request->baseUrl ?>/statics/admin/css/login/style.css" rel="stylesheet"/>
    <link href="<?= Yii::$app->request->baseUrl ?>/statics/admin/favicon.ico" rel="shortcut icon" type="image/x-icon"/>
</head>
        ...
        <div class="login-content">
            <div class="brand">
                <img alt="" class="brand-img"
                     ...
                     width="50"/>
                <h2 class="brand-text">naked中国--后台管理系统</h2>
            </div>
...
<script src="<?= Yii::$app->request->baseUrl ?>/statics/admin/js/jquery.form.js"></script>
