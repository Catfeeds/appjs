...
<div class="alert alert-info rounded-0">
    ...
    <div>注：秒杀入口可以在
        <a target="_blank" href="<?= $urlManager->createUrl(['admin/store/home-nav']) ?>">导航图标</a>、
        <a target="_blank"
           href="<?= $urlManager->createUrl(['admin/store/home-block']) ?>">图片魔方</a>、
        <a target="_blank" href="<?= $urlManager->createUrl(['admin/store/slide']) ?>">轮播图</a>设置。
    </div>
</div>
