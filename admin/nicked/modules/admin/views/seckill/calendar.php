...
?>
<link href="<?= Yii::$app->request->baseUrl ?>/statics/admin/css/jquery.datetimepicker.2.5.12.min.css" rel="stylesheet">
<style>
...
<div class="panel mb-3">
    <div class="panel-header">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createUrl(['admin/seckill/goods']) ?>">按商品查看</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="<?= $urlManager->createUrl(['admin/seckill/calendar']) ?>">按日历查看</a>
            </li>
        </ul>
...
<script>
    ...
    function seckillBoxClick(e) {
        ...
        $.ajax({
            url: '<?= $urlManager->createUrl(["admin/seckill/date"])?>',
            data: {
                date: e.dataset.date,
            },
            dataType: "json",
