...
<div class="panel mb-3" id="app">
    ...
    <div class="panel-body">
        <form class="auto-form" method="post" return="<?= $urlManager->createUrl(['admin/topic/index']) ?>">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="search-goods-form"
                              action="<?= $urlManager->createUrl(['admin/topic/search-goods']) ?>">
                            <div class="input-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="search-video-form"
                              action="<?= $urlManager->createUrl(['admin/topic/search-video']) ?>">
                            <div class="input-group">
