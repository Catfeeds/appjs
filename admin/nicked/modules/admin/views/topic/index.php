...
<div class="panel mb-3">
    <div class="panel-header">
        ...
        <ul class="nav nav-right">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createUrl(['admin/topic/edit']) ?>">添加专题</a>
            </li>
        </ul>
    </div>
                    ...
                    <td class="text-center">
                        <div class="mb-2">
                            <a class="btn btn-sm btn-primary"
                               href="<?= $urlManager->createUrl(['admin/topic/edit', 'id' => $item->id]) ?>">编辑</a>
                        </div>
                        <div>
                            <a class="btn btn-sm btn-danger delete-btn"
                               href="<?= $urlManager->createUrl(['admin/topic/delete', 'id' => $item->id]) ?>">删除</a>
                        </div>
                    </td>
                </tr>
            <?php endforeach ?>
