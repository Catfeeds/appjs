...
$this->params['page_navs'] = [
    [
        'name' => '关于我们',
        'active' => $cat_id == 1,
        'url' => $urlManager->createUrl(['admin/article/index', 'cat_id' => 1,]),
    ],
    [
        'name' => '服务中心',
        'active' => $cat_id == 2,
        'url' => $urlManager->createUrl(['admin/article/index', 'cat_id' => 2,]),
    ],
];
?>
    ...
    <div class="panel-header">
        ...
        <?php if ($cat_id != 1): ?>
            <ul class="nav nav-right">
                <li class="nav-item">
                    <a class="nav-link"
                       href="<?= $urlManager->createAbsoluteUrl(['admin/article/edit', 'cat_id' => 2]) ?>">添加文章</a>
                </li>
            </ul>
        <?php endif; ?>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['admin/article/edit', 'cat_id' => $item->article_cat_id, 'id' => $item->id]) ?>">编辑</a>
                        <?php if ($cat_id != 1): ?>
                            ...
                            <a class="btn btn-sm btn-danger article-delete"
                               href="<?= $urlManager->createUrl(['admin/article/delete', 'id' => $item->id]) ?>">删除</a>
                        <?php else: ?>
                            <a class="btn btn-sm btn-primary copy"
