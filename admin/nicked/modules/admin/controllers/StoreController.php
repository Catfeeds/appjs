...
use app\modules\admin\models\MailForm;
use app\modules\admin\models\NavbarEditForm;
use app\modules\admin\models\AttrAddForm;
use app\modules\admin\models\AttrDeleteForm;
use app\modules\admin\models\AttrUpdateForm;
use app\modules\admin\models\BannerForm;
use app\modules\admin\models\CatForm;
use app\modules\admin\models\DeliveryForm;
use app\modules\admin\models\DistrictForm;
use app\modules\admin\models\HomeBlockEditForm;
use app\modules\admin\models\HomeNavEditForm;
use app\modules\admin\models\Model;
use app\modules\admin\models\PostageRulesEditForm;
use app\modules\admin\models\SenderForm;
use app\modules\admin\models\ShopForm;
use app\modules\admin\models\SmsForm;
use app\modules\admin\models\StoreDataForm;
...
use app\modules\admin\models\WechatSettingForm;
use app\modules\admin\models\WxdevToolPreviewForm;
use app\modules\admin\models\WxdevToolUploadForm;
...
class StoreController extends Controller
{
    ...
    public function actionNavbarReset()
    {
        ...
        Yii::$app->response->redirect(Yii::$app->urlManager->createUrl(['admin/store/navbar']))->send();
    }
